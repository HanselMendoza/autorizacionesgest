...
namespace GestionAutorizaciones.Application.Asegurado.Common
{
    public interface IAseguradoRepositorio
    {
        ...
        Task<OrigenPlastico> ObtenerOrigenPlasticoHistorico(long numeroPlastico);
        ...
        Task<Afiliado> ObtenerAfiliadoHistorico(string tipoId, string identificacion, int compania);
